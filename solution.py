...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        pyrosim.Send_Cube(name="Torso", pos=[0, 0, 1], size=[2, .5, .5])
        
        pyrosim.Send_Joint(name="Torso_BackRightLeg", parent="Torso", child="BackRightLeg", type="revolute", position=[-1, -.2, 1], jointAxis="0 0 1")
        pyrosim.Send_Cube(name="BackRightLeg", pos=[0, -.5, 0], size=[.2, 1, .2])
        ...
        pyrosim.Send_Joint(name="Torso_BackLeftLeg", parent="Torso", child="BackLeftLeg", type="revolute", position=[-1, 0.2, 1], jointAxis="0 0 1")
        pyrosim.Send_Cube(name="BackLeftLeg", pos=[0,.5,0], size=[.2, 1, .2])
        ...
        pyrosim.Send_Joint(name="Torso_MiddleRightLeg", parent="Torso", child="MiddleRightLeg", type="revolute", position=[0, -.2, 1], jointAxis="0 0 1")
        ...
        pyrosim.Send_Joint(name="Torso_MiddleLeftLeg", parent="Torso", child="MiddleLeftLeg", type="revolute", position=[0, 0.2, 1], jointAxis="0 0 1")
        ...
        pyrosim.Send_Joint(name="Torso_FrontRightLeg", parent="Torso", child="FrontRightLeg", type="revolute", position=[1, -.2, 1], jointAxis="0 0 1")
        pyrosim.Send_Cube(name="FrontRightLeg", pos=[0, -.5, 0], size=[.2, 1, .2])
        ...
        pyrosim.Send_Joint(name="Torso_FrontLeftLeg", parent="Torso", child="FrontLeftLeg", type="revolute", position=[1, 0.2, 1], jointAxis="0 0 1")
        pyrosim.Send_Cube(name="FrontLeftLeg", pos=[0,.5,0], size=[.2, 1, .2])
    ...
    def Create_Brain(self, myID):
        ...
        pyrosim.Send_Sensor_Neuron(name=2, linkName="MiddleRightLeg")
        pyrosim.Send_Sensor_Neuron(name=3, linkName="FrontRightLeg")
        pyrosim.Send_Sensor_Neuron(name=4, linkName="BackLeftLeg")
        pyrosim.Send_Sensor_Neuron(name=5, linkName="MiddleLeftLeg")
        pyrosim.Send_Sensor_Neuron(name=6, linkName="FrontLeftLeg")

        pyrosim.Send_Motor_Neuron(name=7, jointName="Torso_BackRightLeg"),
        pyrosim.Send_Motor_Neuron(name=8, jointName="Torso_MiddleRightLeg")
        pyrosim.Send_Motor_Neuron(name=9, jointName="Torso_FrontRightLeg"),
        pyrosim.Send_Motor_Neuron(name=10, jointName="Torso_BackLeftLeg")
        pyrosim.Send_Motor_Neuron(name=11, jointName="Torso_MiddleLeftLeg")
