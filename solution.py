...
class SOLUTION:
    ...
    def Create_Body(self):
        ...
        # pyrosim.Send_Joint(name="Torso_BackMiddleLeg", parent="Torso", child="BackMiddleLeg", type="revolute", position=[-.5, 0, 1], jointAxis="0 1 0")
        # pyrosim.Send_Cube(name="BackMiddleLeg", pos=[-.5,0,0], size=[1, .2, .2])
        
        # pyrosim.Send_Joint(name="BackMiddleLeg_BackMiddleLowerLeg", parent="BackMiddleLeg", child="BackMiddleLowerLeg", type="revolute", position=[-1, 0, 0], jointAxis="0 1 0")
        # pyrosim.Send_Cube(name="BackMiddleLowerLeg", pos=[0,0,-.5], size=[.2, .2, 1])
        ...
        # pyrosim.Send_Joint(name="Torso_FrontMiddleLeg", parent="Torso", child="FrontMiddleLeg", type="revolute", position=[.5, 0, 1], jointAxis="0 1 0")
        # pyrosim.Send_Cube(name="FrontMiddleLeg", pos=[.5, 0, 0], size=[1, .2, .2])
        
        # pyrosim.Send_Joint(name="FrontMiddleLeg_FrontMiddleLowerLeg", parent="FrontMiddleLeg", child="FrontMiddleLowerLeg", type="revolute", position=[1, 0, 0], jointAxis="0 1 0")
        # pyrosim.Send_Cube(name="FrontMiddleLowerLeg", pos=[0,0,-.5], size=[.2, .2, 1])
